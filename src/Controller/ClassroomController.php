...
class ClassroomController extends AbstractController
{
    ...
    #[Route('/{ref}', name: 'app_classroom_show', methods: ['GET'])]
    ...
    #[Route('/{ref}/edit', name: 'app_classroom_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{ref}', name: 'app_classroom_delete', methods: ['POST'])]
    public function delete(Request $request, Classroom $classroom, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$classroom->getRef(), $request->request->get('_token'))) {
